        ...
        retriever
                ...
                .compose(
                        (JsonObject conf) -> {
                            ...
                            JsonObject projectServiceConf =
                                    projectConf.getJsonObject(PROJECT_SERVICE_CONF);
                            ...
                            String address =
                                    projectServiceConf.getString(PROJECT_SERVICE_ADDRESS_CONF);
                            ...
                            JsonObject execServiceConf =
                                    projectConf.getJsonObject(EXEC_SERVICE_CONF);
                            String execServiceAddress =
                                    execServiceConf.getString(EXEC_SERVICE_ADDRESS_CONF);
                            ...
                            workerExecutor =
                                    vertx.createSharedWorkerExecutor("project-worker-executor", 1);
                            provider =
                                    IProjectService.createProvider(
                                            getVertx(),
                                            mongo,
                                            workerExecutor,
                                            execService,
    ...
    public static class RestApi {
        ...
        public void add(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found projectName in request.",
                    400)) {
                return;
            }
        ...
        public void createFromExec(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found exec id in request.",
                    400)) {
                return;
            }
        ...
        public void heartOfDeployId(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found deploy id in request.",
                    400)) {
                return;
            }
        ...
        public void updateProject(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found project id in request.",
                    400)) {
                return;
            }
            ...
            if (OnFailure.doTry(
                    ...
                    "The new project name in request is invalid.",
                    400)) {
                return;
            }
            ...
            try {
                ...
                if (OnFailure.doTry(
                        ...
                        "The pkgs in request is invalid.",
                        400)) {
                    return;
                }
            }
            ...
            try {
                ...
                if (OnFailure.doTry(
                        ...
                        "The platform in request is invalid.",
                        400)) {
                    return;
                }
            }
            ...
            try {
                ...
                if (OnFailure.doTry(
                        ...
                        "The backendArgs in request is invalid.",
                        400)) {
                    return;
                }
            }
            ...
            try {
                ...
                if (OnFailure.doTry(
                        ...
                        "The spec in request is invalid.",
                        400)) {
                    return;
                }
            }
        ...
        public void updateName(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found project name in request.",
                    400)) {
                return;
            }
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found new project name in request.",
                    400)) {
                return;
            }
            ...
            service.updateName(userId, name, newName)
                    .onSuccess(
                            (JsonObject project) -> {
                                ...
                                resp.put("status", "OK").put("data", project);
        ...
        public void updateDeployConfs(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found legal updateConfs in request.",
                    400)) {
                return;
            }
        ...
        public void updateSpec(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found legal spec in request.",
                    400)) {
                return;
            }
        ...
        public void updatePlatform(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found legal platform in request.",
                    400)) {
                return;
            }
        ...
        public void updateBackendArgs(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found legal backend arguments in request.",
                    400)) {
                return;
            }
            List<String> backendArgList = JsonConvertor.jsonArrayToList(backendArgs);
        ...
        public void analysisSubSpecOfId(RoutingContext ctx) {
            ...
            if (OnFailure.doTry(
                    ...
                    "Fail to found legal subSpec in request.",
                    400)) {
                return;
            }
        ...
        public void analysisCurrent(RoutingContext ctx) {
            ...
            service.getSpecOfName(userId, name)
                    .compose(
                            (JsonObject spec) -> {
                                try {
                                    SpecJson.check(spec);
