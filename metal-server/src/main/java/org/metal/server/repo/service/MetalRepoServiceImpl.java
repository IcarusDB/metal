...
public class MetalRepoServiceImpl implements IMetalRepoService {
    ...
    private boolean checkManifest(JsonObject manifest) throws IllegalArgumentException {
        String[] metalTypes = new String[] {"sources", "mappers", "fusions", "sinks", "setups"};
    ...
    public Future<String> add(String userId, String type, String scope, JsonObject metal) {
        ...
        return MetalRepoDB.add(
                mongo, userId, metalType, metalScope, pkg, clazz, formSchema, uiSchema);
    }
    ;
    ...
    public Future<List<JsonObject>> getAllOfPublic() {
        return ReadStreamCollector.<JsonObject>toList(MetalRepoDB.getAllOfPublic(mongo));
    }

    @Override
    public Future<List<JsonObject>> getAllOfPkg(
            String userId, String groupId, String artifactId, String version) {
        return MetalRepoDB.getAllOfPkg(
                mongo,
                userId,
                groupId,
