...
public class ExecDB {
    ...
    public static final String DB = "execs";
    public static final String FIELD_ID = "_id";
    public static final String FIELD_USER_ID = "userId";
    public static final String FIELD_CREATE_TIME = "createTime";
    public static final String FIELD_SUBMIT_TIME = "submitTime";
    public static final String FIELD_BEAT_TIME = "beatTime";
    public static final String FIELD_FINISH_TIME = "finishTime";
    public static final String FIELD_TERMINATE_TIME = "terminateTime";
    public static final String FIELD_STATUS = "status";

    public static final String FIELD_DEPLOY = "deploy";
    public static final String FIELD_FROM_PROJECT = "fromProject";
    ...
    public static Future<JsonObject> updateStatus(
            MongoClient mongo, String execId, JsonObject execStatus) {
    ...
    public static Future<JsonObject> updateByPath(
            MongoClient mongo, String execId, JsonObject updateByPath) {
        return mongo.updateCollection(
                        DB,
                        new JsonObject().put(FIELD_ID, execId),
    ...
    public static Future<JsonObject> getOfId(MongoClient mongo, String execId) {
        return mongo.findOne(DB, new JsonObject().put(FIELD_ID, execId), new JsonObject())
                .compose(
                        (JsonObject exec) -> {
    ...
    private static JsonObject compatJsonOnPlatform(JsonObject exec) {
        JsonObject platform =
                exec.getJsonObject(FIELD_DEPLOY).getJsonObject(ProjectDB.DEPLOY_PLATFORM);
    ...
    public static Future<List<JsonObject>> getAllOfMatcher(MongoClient mongo, JsonObject matcher) {
        ...
        JsonArray pipeline = new JsonArray().add(match).add(lookup).add(project).add(reduceProject);
    ...
    public static Future<List<JsonObject>> getAllOfUserNoDetail(MongoClient mongo, String userId) {
        ...
        return ReadStreamCollector.<JsonObject, JsonObject>toList(
                mongo.findBatch(DB, matcher), ExecDB::noDetail);
    }
    ...
    public static Future<List<JsonObject>> getAllOfProjectNoDetail(
            MongoClient mongo, String projectId) {
        JsonObject matcher = new JsonObject();
        matcher.put(FIELD_FROM_PROJECT, projectId);
    ...
    public static Future<JsonObject> forceRemove(MongoClient mongo, String userId, String execId) {
        return mongo.removeDocument(
                        DB, new JsonObject().put(FIELD_USER_ID, userId).put(FIELD_ID, execId))
                .compose(
                        ret -> {
    ...
    public static Future<JsonObject> forceRemoveAllOfProject(
            MongoClient mongo, String userId, String projectId) {
    ...
    public static Future<JsonObject> remove(MongoClient mongo, String userId, String execId) {
        ...
        return mongo.removeDocument(DB, matcher)
                .compose(
                        ret -> {
                            return Future.succeededFuture(ret.toJson());
                        });
        ...
        matcher.put(
                ...
                new JsonObject()
                        .put(
                                "$in",
                                new JsonArray()
                                        .add(ExecState.FINISH.toString())
                                        .add(ExecState.FAILURE.toString())));
        return matcher;
    }
    ...
    public static Future<JsonObject> removeAllOfProject(
            MongoClient mongo, String userId, String projectId) {
        JsonObject matcher = terminateMatcher();
        matcher.put(FIELD_USER_ID, userId);
        matcher.put(FIELD_FROM_PROJECT, projectId);
