...
public class IMSourcePropsTest {
    ...
    @Test
    public void testSer() {
        IMSourcePropsFoo properties = ImmutableIMSourcePropsFoo.builder().schema("{}").build();
    ...
    public void testDeser() {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            System.out.println(mapper.readValue(json, IMSourcePropsFoo.class));
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }
    }
    ...
    public void testInnerSer() {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            System.out.println(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(outter));
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }
    }
    ...
    public void testInnerDesr() {
        ...
        ObjectMapper mapper = new ObjectMapper();
        try {
            System.out.println(mapper.readValue(json, Outter.class));
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }
    }
