...
//          "../libs/spec.json"
//      };
//    String metalJars = "../lib/metal-backend-1.0.0-SNAPSHOT.jar,../lib/metal-backend-api-1.0.0-SNAPSHOT.jar,../lib/metal-core-1.0.0-SNAPSHOT.jar,../lib/metal-on-spark-1.0.0-SNAPSHOT.jar,../lib/metal-on-spark-extensions-1.0.0-SNAPSHOT.jar,../lib/metal-server-1.0.0-SNAPSHOT.jar";
//    String[] argv = {
//        "--class", "org.metal.backend.BackendLauncher",
//        "--master", "local[*]",
//        "--deploy-mode", "cluster",
